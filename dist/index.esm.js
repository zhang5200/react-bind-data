...
const MittContext = React.createContext({ emitter });
const MittProvider = ({ children }) => {
    return (React.createElement(MittContext.Provider, { value: { emitter } }, children));
};
const useMitt = () => {
...
const Provider = (props) => {
    ...
    return React.createElement(Provide.Provider, { value: value }, children);
};
...
export { useMitt$1 as mitt, useProvide as provide, useReactive, useWatch, utils };
